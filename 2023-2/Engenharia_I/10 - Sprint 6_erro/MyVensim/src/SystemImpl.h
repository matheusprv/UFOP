...
protected:
    /** @brief Name of the SystemHandle */
    string name;
...
public: 
    ...
    */
    SystemImpl& operator=(const System& system);
...
/**
* @brief   Definition of class SystemHandle, which represents the current value of the system
*/
...
public: 
    // Construtores
    /**
     * @brief   Constructor for SystemHandle with name and value.
     * @param   name Name of the system.
     * @param   value Value of the system.
    */
    ...
    */
    ...
    /**
    * @brief   Virtual destructor for the SystemHandle class.
    */
    ...
    */
    ...
    //Sobrecarga de operadores
    /**
     * @brief   Overload of operator equals to copy a SystemHandle.
     * @param   system Object to be copied.
     * @return  Reference to the copied SystemHandle.
    */
    ...
    */
     ...
     * @return  ostream with the system display format.
    */
    friend ostream & operator << (ostream & out, const SystemHandle & system);
};
