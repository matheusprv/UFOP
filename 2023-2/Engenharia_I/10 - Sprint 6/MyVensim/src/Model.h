...
public:
    ...
    */
    virtual int run(int tempo_inicial, int tempo_final) = 0;
    ...
    */
     ...
     * @param source Pointer to the system that will be the source of the code.
     * @param target Pointer to system that will receive the updated value.
