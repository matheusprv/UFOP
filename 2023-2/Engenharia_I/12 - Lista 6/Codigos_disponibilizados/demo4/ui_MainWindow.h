...
public:
    ...
    QObject::connect(radioButtonSoma, SIGNAL(clicked()), execButton, SLOT(click()));
    QObject::connect(radioButtonSub, SIGNAL(clicked()), execButton, SLOT(click()));
    QObject::connect(radioButtonMult, SIGNAL(clicked()), execButton, SLOT(click()));
    QObject::connect(radioButtonDiv, SIGNAL(clicked()), execButton, SLOT(click()));
