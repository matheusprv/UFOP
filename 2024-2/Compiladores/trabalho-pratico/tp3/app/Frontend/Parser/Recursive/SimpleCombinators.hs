...
module Frontend.Parser.Recursive.SimpleCombinators ( module Frontend.Parser.Recursive.SimpleCombinators
                                          , Alternative (..)
                                          ) where
...
matchToken :: Lexeme -> Parser Token Token
...
ltgt :: Parser Token a -> Parser Token a
