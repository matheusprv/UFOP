module Limp.Frontend.Semantics.StatementTypeChecker where

import Limp.Frontend.Semantics.Basics
import Limp.Frontend.Semantics.ExpTypeChecker
...
tcBlock ctx (Block itens) 
  = tcStmts ctx $ filterItemStmt itens -- Os itens podem nao ser ItemStmt -- devem ser filtrados
